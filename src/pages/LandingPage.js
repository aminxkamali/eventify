...
export default function LandingPage() {
    return (
        <>
            <SEO
                title="Eventify | Discover, Create, and Manage Events Effortlessly"
                description="Eventify is your all-in-one platform for discovering, creating, and managing events with friends and teams. Join communities, chat, and never miss a moment!"
                keywords="event, event management, community, chat, schedule, friends, teams, discover, create, organize"
            />
